...
/**
 * Tests for {@link ListDependenciesHandler}.
 */
public class TestListDependenciesHandler extends TestCase {
    ...
    public void testNullServiceRejected() {
        try {
            new ListDependenciesHandler(null);
    ...
    public void testReturns200AndEmptyForFreshDiagram() {
        ResponseEnvelope env = new ListDependenciesHandler(svc).handle(
    ...
    public void testReturns200AndListsAddedDependency() {
    ...
    public void testIgnoresAssociations() {
        ...
        ResponseEnvelope env = new ListDependenciesHandler(svc).handle(
                ppFor(), new HashMap<String, String>(), "");
        assertEquals(200, env.status);
        assertTrue("body must have empty data (assoc not dep): "
    ...
    public void testMissingDiagramThrowsNotFound() {
        ...
        pp.put("d", "NoSuch");
        try {
            new ListDependenciesHandler(svc).handle(pp,
