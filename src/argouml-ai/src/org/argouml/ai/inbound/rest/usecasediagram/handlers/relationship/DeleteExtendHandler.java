...
/**
 * Handler for {@code DELETE /d/{d}/usecasediagram/extends/{id}}.
 * 204 on success, 404 EXTEND_NOT_FOUND.
 */
public final class DeleteExtendHandler implements IRequestHandler {

    private final UseCaseDiagramService svc;

    public DeleteExtendHandler(UseCaseDiagramService svc) {
        if (svc == null) {
    ...
    public ResponseEnvelope handle(Map<String, String> pathParams,
        ...
        if (id == null || id.isEmpty()) {
            return ResponseEnvelope.json(400, JsonError.of("INVALID_NAME",
                    "Extend id required in path"));
        }
        svc.deleteExtend(diagram, id);
