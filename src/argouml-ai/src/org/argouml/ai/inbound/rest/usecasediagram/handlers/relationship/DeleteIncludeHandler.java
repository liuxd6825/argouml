...
/**
 * Handler for {@code DELETE /d/{d}/usecasediagram/includes/{id}}.
 * 204 on success, 404 INCLUDE_NOT_FOUND.
 */
public final class DeleteIncludeHandler implements IRequestHandler {

    private final UseCaseDiagramService svc;

    public DeleteIncludeHandler(UseCaseDiagramService svc) {
        if (svc == null) {
    ...
    public ResponseEnvelope handle(Map<String, String> pathParams,
        ...
        if (id == null || id.isEmpty()) {
            return ResponseEnvelope.json(400, JsonError.of("INVALID_NAME",
                    "Include id required in path"));
        }
        svc.deleteInclude(diagram, id);
